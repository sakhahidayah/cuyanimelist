...
const Navbar = () => {
  return (
    <div className="w-full flex bg-[#44aff4] md:flex-row flex-col items-center justify-between border border-b-slate-400 px-12 py-4 gap-2 text-white">
      <Link href={"/"} className="font-bold text-xl md:text-2xl">
        ANIMELIST
      </Link>
      <div className="relative">
        <input className="focus:outline-2 focus:border-0 focus:outline-[#bfbc78]  border rounded-xl px-2 py-1 w-full" type="text" placeholder="Search..."></input>
        <button className="absolute right-3 top-1  cursor-pointer hover:scale-125 flex justify-center items-center">
